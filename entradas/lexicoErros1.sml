#Este arquivo contem um erro na linha 2. A linguagem não aceita o símbolos '*' e '@' nos identificadores
PREFIX f*@n:     <http://aksw.org/sparqlify/>
...
#
  ?IDHvalue  rdf:type  rdf:Class     ;
             ...
             rdf:type  scv:dimension ;
             rdf:value  ?IDHV        .
# lexico no fim, não tem um ponto
