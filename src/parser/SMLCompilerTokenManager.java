/* SMLCompilerTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. SMLCompilerTokenManager.java */
package parser;
import java.io.*;
import tree.*;

/** Token Manager. */
@SuppressWarnings("unused")public class SMLCompilerTokenManager implements SMLCompilerConstants {
   ...
   switch(curChar)
   {
      case 101:
         if ((active0 & 0x40000L) != 0L)
            return jjStartNfaWithStates_0(8, 18, 3);
         return jjMoveStringLiteralDfa9_0(active0, 0x30000L);
      case 116:
         if ((active0 & 0x400L) != 0L)
            return jjStartNfaWithStates_0(8, 10, 3);
         break;
      default :
         break;
   }
   ...
   switch(curChar)
   {
      case 108:
         if ((active0 & 0x10000L) != 0L)
            return jjStartNfaWithStates_0(11, 16, 3);
...
static final int[] jjnextStates = {
   13, 14, 15, 16, 9, 10, 13, 14, 15, 16, 
};

/** Token literal values. */
public static final String[] jjstrLiteralImages = {
"", null, null, null, null, null, "\120\122\105\106\111\130", 
"\103\122\105\101\124\105", "\126\111\105\127", "\101\163", "\103\157\156\163\164\162\165\143\164", 
"\127\111\124\110", "\163\164\162", "\143\157\156\143\141\164", "\142\156\157\144\145", 
"\165\162\151", "\160\154\141\151\156\114\151\164\145\162\141\154", 
"\164\171\160\145\144\114\151\164\145\162\141\154", "\165\162\154\105\156\143\157\144\145", "\50", "\51", "\173", "\175", "\77", 
"\73", "\56", "\54", "\72", "\75", null, null, null, null, null, null, null, null, 
null, };
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public SMLCompilerTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public SMLCompilerTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
